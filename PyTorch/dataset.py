...
class YOLODataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ]  # 6 -> [probability_object, x_center, y_center, width, height, class]
...
def test():
    ...
    dataset = YOLODataset(
        "/home/marcos/Datasets/COCO/train.csv",
        "/home/marcos/Datasets/COCO/images/",
        "/home/marcos/Datasets/COCO/labels/",
        S=[13, 26, 52],
        anchors=anchors,
        transform=transform,
    )
